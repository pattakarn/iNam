package com.sungkunn.inam.old_ver.fragment.ui.hotel
...
class HotelMainFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        var rootView =  inflater.inflate(R.layout.fragment_hotel_main, container, false)
        ...
        adapter.addFragment(HotelInfoFragment.newInstance(key, name, type), "Info")
