 ...
 *
 */
class StockListFragment : Fragment(), View.OnClickListener, Toolbar.OnMenuItemClickListener {
    ...
    override fun onCreateView(
        ...
        var rootView = inflater.inflate(R.layout.fragment_stock_list, container, false)
        ...
        var spinZone = rootView.findViewById<Spinner>(R.id.spin_zone)
        var spinShop = rootView.findViewById<Spinner>(R.id.spin_shop)
        ...
        var listItem = arrayOf("Stock 1", "Stock 2", "Stock 3")
...
//                    .replace(R.id.container_manage, StockItemFragment.newInstance("", ""))
//                    .addToBackStack(null)
//                    .commit()
