...
class RV_Adapter_Product_Pack_Grid_List() :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    var items: ArrayList<ProductPackDao>? = null
    var fragmentManager: FragmentManager? = null
    var arrList = ArrayList<ProductPackDao>()
    lateinit var inflater: LayoutInflater
//    var listField : Array<String> = inflater.context.resources.getStringArray(R.array.information)

    constructor(items: ArrayList<ProductPackDao>, fragmentManager: FragmentManager) : this() {
        this.items = items
