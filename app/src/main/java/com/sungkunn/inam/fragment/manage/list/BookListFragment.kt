 ...
 *
 */
class BookListFragment : Fragment(), View.OnClickListener, Toolbar.OnMenuItemClickListener {
    ...
    override fun onCreateView(
        ...
        var rootView = inflater.inflate(R.layout.fragment_book_list, container, false)
        ...
        var listItem = arrayOf("Book 1", "Book 2", "Book 3")
